...
<script type="text/javascript">
    $(function () {
        $("#btn").click(function () {
            ...
            var confirmPassword = $("#txt_scpassword").val();
  ...
  <body>
      <form action="signup" method="POST"> 
            ...
            try
        {
         ...
         String sql="select signup_id from tbl_signup";
         ResultSet rs= st.executeQuery(sql);
         while(rs.next())
         { 
           id=String.valueOf(Integer.parseInt(rs.getString("signup_id"))+1);
         }
...
<div class="row">
  <div class="col-sm-2"></div>
  <div class="col-sm-8">
    <label for="txt_susername" class="form-label">Username</label>
    <div class="input-group has-validation">
      <input type="text" onkeypress="javascript:return isString(event)" class="form-control" id="txt_susername" name="txt_susername" aria-describedby="inputGroupPrepend" placeholder="Enter Username" required="">
  ...
  <div class="col-sm-2"></div>
  <div class="col-sm-8">
    <label for="txt_spassword" class="form-label">Password</label>
  ...
  <div class="col-sm-2"></div>
  <div class="col-sm-8">
    <label for="txt_scpassword" class="form-label"> Confirm Password</label>
    <input type="password" class="form-control" id="txt_scpassword" name="txt_scpassword" placeholder="Enter Password" required="">
  </div>
  <div class="col-sm-2"></div>
   </div>        
    </div>
