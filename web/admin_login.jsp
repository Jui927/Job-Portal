...
<html lang="en">
  ...
  <body>
   ...
   <div class="container-fluid bg-gray  py-3">
       <header class="text-center">
           <h1 class="display-9">Admin Login</h1>
       </header>
   </div>
   <section class="container my-2 bg-gray  p-2 " >
       <form class="row g-3 p-3" action="admin_login" method="POST">
      
      <div class="container-fluid"> 
        <div class="row">
        <div class="col-sm-2"></div>
  <div class="col-sm-8">
    <label for="txt_luname" class="form-label">Admin name</label>
    <div class="input-group has-validation">
      <input type="text" class="form-control" id="txt_luname" name="txt_luname" aria-describedby="inputGroupPrepend" placeholder="Enter Username" >
  ...
  <div class="col-sm-8">
    ...
    <a href="admin_signup.jsp" style="margin-left:360px">Create new account</a>
  <div class="col-sm-2"></div>
   </div>
